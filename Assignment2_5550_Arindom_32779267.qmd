...
retail %>% autoplot(Turnover) + labs(x = "Date",y = "Turnover (mil $)",title="Retailing turnover in Australia over time",caption = "Source: Australian Bureau of Statistics") + theme(plot.title = element_text(hjust = 0.5)) + theme_minimal()
```
:::{.callout-note}
# Key takeaway
